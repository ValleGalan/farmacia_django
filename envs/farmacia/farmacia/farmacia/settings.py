...
SECRET_KEY = 'django-insecure-vfff5nn*bem2ft8uwdyeek%^u7c%qyy0e5w1y$#wsc=84s#c)i'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Farmacia.db',#BASE_DIR / 'db.sqlite3',
    }
}
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': datetime.timedelta(days=120)#CUANTO DURA EL TOKEN 
}
#________-
